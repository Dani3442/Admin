...
export function DashboardShell({
  ...
  useEffect(() => {
    if (!canCreateProduct || typeof window === 'undefined') return

    const handleOpen = () => {
      openCreateProductModal()
    }

    window.addEventListener('product-admin:open-create-modal', handleOpen)
    return () => window.removeEventListener('product-admin:open-create-modal', handleOpen)
  }, [canCreateProduct])
